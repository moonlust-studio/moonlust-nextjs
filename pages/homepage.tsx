...
export const metadata: Metadata = {
  title: "Moonlust - Trang chủ",
  description: "Khám phá vũ trụ truyện người lớn tinh tế, cảm xúc và nghệ thuật.",
  keywords: ["truyện người lớn", "gợi cảm", "văn học 18+", "moonlust"],
  openGraph: {
    title: "Moonlust - Truyện gợi cảm nghệ thuật",
    description: "Đắm chìm trong thế giới truyện nóng bỏng nhưng tinh tế.",
    images: ["/og-image.jpg"]
  }
};
