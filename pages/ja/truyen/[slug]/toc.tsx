// ✅ File: pages/ja/truyen/[slug]/toc.tsx – Danh sách chương tiếng Nhật
  ...
  if (!story) {
    return (
      <div className="text-center py-20">
        ...
        <Link href="/ja/truyen" className="text-pink-600 underline mt-4 inline-block">
    ...
    <>
      ...
      <main className="max-w-3xl mx-auto px-4 py-10">
        <div className="mb-4 text-center">
          <Link href={`/ja/truyen/${story.slug}`} className="text-pink-600 underline text-sm">
        ...
        {chapterList.length > 0 ? (
          <ul className="space-y-3">
            {chapterList.map((chapter) => (
              <li key={chapter.id}>
                <Link
                  href={`/ja/truyen/${story.slug}/chapters/${chapter.id}`}
