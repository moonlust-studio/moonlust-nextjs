...
const getStaticPaths = async ({ locales })=>{
    const paths = locales.flatMap((locale)=>(mockStories/* default */.Z[locale] || []).map((story)=>({
                params: {
                    slug: story.slug
                },
                locale
...
var __webpack_exports__ = __webpack_require__.X(0, [940,815,664,142,636,675,178,298,845], () => (__webpack_exec__(3394)));
